...
export default function NextEvent() {
  return (
    <section id="next-event" className="section section--gold-light" aria-label="Upcoming events">
      <div className="container next-event-layout">
        ...
        <div className="next-event-image-wrap">
          <img
            src="/events-classroom.png"
            alt="People learning together at a Square AI Academy session"
